...
| tpa_single_node_client_tls_ca_certificates | Comma separated list of client CA certificates | str |  |
...
- hosts: rhtpa
  vars:
    ...
    tpa_single_node_client_tls_ca_certificates: # TODO: required, type: str
